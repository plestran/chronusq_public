...
void AOIntegrals::Gen34Contract(TMat &G, const TMat &X, int bf1, int bf2, 
  int bf3, int bf4, T v){
...
template<typename TMat, typename T>
void AOIntegrals::GenCouContractSpinor(TMat &G, const TMat &X, int bf1, 
  int bf2, int bf3, int bf4, T v){
 ...
 */
template<typename TMat, typename T> 
void AOIntegrals::Gen23Contract(TMat &G, const TMat &X, int bf1, int bf2, 
  int bf3, int bf4, T v, double fact){
...
template<typename TMat, typename T> 
void AOIntegrals::GenExchContractSpinor(TMat &G, const TMat &X, int bf1, 
  int bf2, int bf3, int bf4, T v, double fact){
 ...
 */
template<typename TMat, typename T>
void AOIntegrals::Gen24Contract(TMat &G, const TMat &X, int bf1, int bf2, int bf3, int bf4, T v){
...
template<typename TMat, typename T>
void AOIntegrals::Spinor24Contract(TMat &G, const TMat &X, int bf1, int bf2, int bf3, int bf4, T v){
  G(bf1,bf3) += X(bf2,bf4)*v;
  G(bf2,bf3) += X(bf1,bf4)*v;
  G(bf1,bf4) += X(bf2,bf3)*v;
  G(bf2,bf4) += X(bf1,bf3)*v;
