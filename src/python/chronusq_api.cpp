...
BOOST_PYTHON_MODULE(libpythonapi){
  class_<SingleSlater<double>,boost::noncopyable>("SingleSlater_double",
    ...
    .def("printTimings" , &SingleSlater<double>::printTimings        )
    .def("printSCFResults" , &SingleSlater<double>::printSCFResults        )
...
//  .def_readwrite("isHF"         , &SingleSlater<double>::isHF            )
  ...
  class_<SingleSlater<dcomplex>,boost::noncopyable>("SingleSlater_complex",
    ...
    .def("printTimings" , &SingleSlater<dcomplex>::printTimings        )
    .def("printTimings" , &SingleSlater<dcomplex>::printTimings        )
    .def("printSCFResults" , &SingleSlater<dcomplex>::printSCFResults        )
